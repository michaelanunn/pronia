...
export default function ProfileSettings() {
  ...
  const loadProfile = async (userId: string) => {
    ...
    if (data) {
      ...
      setBio(data.bio || '')
      setPianoYears(data.piano_years?.toString() || '')
      setLearningMethod(data.learning_method || 'classes')
    }
    setLoading(false)
  }
            ...
            <form onSubmit={updateProfile} className="space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  You can change your username anytime. Old links will redirect automatically.
                </p>
              </div>
...
<div>
  ...
  <select
    ...
    onChange={(e) => setLearningMethod(e.target.value as 'self-taught' | 'classes')}
    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
  >
